...
public class Main {
    ...
    //------------------------------------------------------------------------------------------------------------------
    private static String importantFunctions = "void manage_memory_TYPE(struct dynar_TYPE *dynar_NAME) {\n"+
    ...
    "void push_TYPE(struct dynar_TYPE *dynar_NAME, int value) {\n"+
        "manage_memory_TYPE(dynar_NAME);\n"+
        "dynar_NAME->array[dynar_NAME->len] = value;\n"+
        "dynar_NAME->len++;\n"+
    "}\n"+
    
    "void insert_TYPE(struct dynar_TYPE *dynar_NAME, int value, int index) {\n"+
        "if(index > dynar_NAME->len)\n"+
        ...
        "}\n"+
    "}\n"+
    "void delN_TYPE(struct dynar_TYPE *dynar_NAME, int value, int number) {\n"+
